        ...
        game.entities.forEach((entity) => {
            if (entity.BB && game.camera.knight.BB.collide(entity.BB) && !game.camera.knight.inCutscene) {
                if (!entity.dialogCompleted) {
                    ...
                    } else if (entity.text || (entity instanceof Bonfire) || entity instanceof DungeonDoor || entity instanceof Potion || (game.camera.levelIndex == 'shopkeeper' && entity instanceof Reina && !game.camera.shopMenu)) {
                        ctx.fillStyle = "Black";
